...
import * as emo from '../../assets/script/vanillaEmojiPicker.js';
...
export class EmojiComponent implements OnInit {
  ...
  @Output() onEmoinput = new EventEmitter<any>();
  @Output() onGifinput2 = new EventEmitter<any>();
  ...
  ngOnInit() {
    console.log(emo.EmojiPicker);
    this.currentEMoList = this.emojiObj.People;
    this.selectedmode = this.categoryFlags[0];
    /* this.ep = emo.EmojiPicker({
      trigger: [
        {
          selector: '.trigger',
  ...
  sendtomsg(data) {
    console.log(data);
    this.onEmoinput.emit(data);
  }

  sendselectedgif(data) {
    console.log(data);
    this.onGifinput2.emit(data);
  }

  loadcurrentemo(key) {
    this.selectedmode = key;
    switch (key) {
      case this.categoryFlags[0]:
        this.currentEMoList = this.emojiObj.People;
        break;
      case this.categoryFlags[1]:
        this.currentEMoList = this.emojiObj.Nature;
        break;
      case this.categoryFlags[2]:
        this.currentEMoList = this.emojiObj.Activity;
        break;
      case this.categoryFlags[3]:
        this.currentEMoList = this.emojiObj.Objects;
        break;
      case this.categoryFlags[4]:
        this.currentEMoList = this.emojiObj.Symbols;
        break;
      case this.categoryFlags[5]:
        this.currentEMoList = this.emojiObj.Flags;
        break;

      default:
        break;
    }
    console.log(this.currentEMoList);
  }
}
